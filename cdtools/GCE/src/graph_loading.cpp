...
#include <unistd.h> // Note by Jean-Gabriel Young: Added this import which was previously included by another library.

#include "graph_loading.hpp"

namespace graph_loading {

// Note by Jean-Gabriel Young: Modified from the original source to fix declaration orders (-fpermissive)
